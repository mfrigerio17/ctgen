mc = CtgenSampleModelConstants;  % object with the model constants

ExG = frameE_xh_frameG(mc);      % creates a transform object
...
DxB = frameD_xh_frameB(mc);      % another transform; this one is parametric
